...
class PassWidgetVolumeButton extends StatelessWidget {
  final URIDPass pass;
  bool showHiddenProperties;

  PassWidgetVolumeButton({required this.pass, required this.showHiddenProperties, super.key});
          ...
          child: InteractiveViewer(
            ...
            child: Card(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                PassWidgetPropertiesVolumeButton(pass: pass, showHiddenProperties: showHiddenProperties,),
                const SizedBox(
                  height: 8,
                ),
